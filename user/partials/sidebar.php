...
<?php
// 🔥 normalize role ป้องกัน HR / hr / Pm / pm
$role = strtolower(trim($_SESSION['role_ivt'] ?? 'user'));
?>
...
<li><a class="dropdown-item" href="asset_assign_no_code.php">➕ เพิ่มอุปกรณ์ (ไม่มีรหัส)</a></li>
<li><a class="dropdown-item" href="asset_assign_shared.php">➕ เพิ่มอุปกรณ์ใช้ร่วม</a></li>
</ul>
</li>
...
<ul class="dropdown-menu">
<li><a class="dropdown-item" href="transfer_create.php">➕ สร้างรายการ</a></li>
<li><a class="dropdown-item" href="transfer_list.php">📦 รายการที่ส่ง</a></li>
<li><a class="dropdown-item" href="transfer_receive.php">✔️ ตรวจรับ</a></li>
</ul>
</li>

<?php endif; ?>

<?php if($role === 'pm'): ?> <!-- 🔥 PM เท่านั้น -->
