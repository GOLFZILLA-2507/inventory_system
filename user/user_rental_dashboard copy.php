...
$params = [];
$params[] = $_SESSION['site']; /* 🔥 กรองตามโครงการของ session (กัน error กรณีมีโครงการอื่นๆ) */
if($search){
    $sql .= " AND (
        h.user_no_pc LIKE ?
...
<div class="topbar p-3 bg-success text-white d-flex justify-content-between">
<a class="navbar-brand" href="index.php">📊 สรุปค่าเช่าอุปกรณ์คอมพิวเตอร์ทั้งหมดของโครงการ </td> </a>
<a href="asset_shared_view.php" class="btn btn-light btn-sm">⬅ กลับหน้าหลัก</a>
</div>
